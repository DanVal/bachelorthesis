...
\begin{align}
	...
	Man sieht leicht ein, dass dies wohldefiniert ist und nicht von der Zellzerlegung von $M$ abhängt. Weiter ergibt sich, dass $H_1( M_{ab(G)} ,  p_{ab(G)}) \cong H_1(M,p;\ZZ[ab(G)]$ natürlich isomorph sind. Der Beweis ergibt sich direkt aus der Bemerkung, dass die universelle Überlagerung buchstäblich universell überlagert, also insbesondere $M_{ab(G)}$ \todo{cite Hatcher Kapitel 1.3}
