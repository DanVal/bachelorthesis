...
\section{Folgerungen, Bemerkungen und Beispiele}
    ...
    \begin{bsp}
        Eine (Halb-)Norm auf einem Vektorraum, liefert stets eine (Halb-)Norm auf seinem Dualraum. Diese ist für einen Vektorraum $(V,|\dot|)$ auf dem Dualraum $(V*,||\dot||)$ definiert durch:
        \[
